        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="intro-message">
                    <h1>Fox Valley 2026 Marathon</h1>
                    <h3>A Time For A Long-Lasting Run!</h3>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                ...
                <h2 class="section-heading">Upcoming Marathon Events:<br>Special Thanks</h2>
                <p class="lead">A special thanks to <a target="_blank" href="http://join.deathtothestockphoto.com/">Fox Valley Community</a> for providing the photographs that you see in this template. Visit their website to become an athlete.</p>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5 col-sm-6">
                <hr class="section-heading-spacer">
                <div class="clearfix"></div>
                <h2 class="section-heading">Grand Chute to Menasha</h2>
...
<div class="banner">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h2>Connect to Join The Club:</h2>
            </div>
            <div class="col-lg-6">
